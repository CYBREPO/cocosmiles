          ...
          <div className="footer-container">
            <div className="footer-section">
              ...
              <p>
                ...
                CocoSmile Is Dedicated To Providing High-Quality And Unique
                Water Cups For Children And Adults Alike. Join Us In The
                Movement To Sip - In - Style With CocoSmile!
              </p>
            </div>
            <div className="footer-section">
            ...
            <div className="footer-section">
              ...
              <ul className="d-flex p-0 social-icons" role="list">
                <li className="social-media__item social-media__item--facebook">
                  <a
                    href="https://www.facebook.com/cocosmilecups/"
                    target="_blank"
                    rel="noopener"
                ...
                <li className="social-media__item social-media__item--instagram">
                  <a
                    href="https://www.instagram.com/cocosmilecups/"
                    target="_blank"
                    rel="noopener"
                    className="social-media__link"
                ...
                <li className="social-media__item social-media__item--youtube">
                  <a
                    href="https://www.youtube.com/@cocosmilecups"
                    target="_blank"
                    rel="noopener"
                    className="social-media__link"
                ...
                <li className="social-media__item social-media__item--tiktok">
                  <a
                    href="https://www.tiktok.com/@cocosmilecups"
                    target="_blank"
                    rel="noopener"
                    className="social-media__link"
